...
import * as MessageSmartGpsController from "../controllers/MessageSmartGpsController";
...
messageRoutes.post("/api/messages/send/warnings", tokenAuth, MessageSmartGpsController.send);
