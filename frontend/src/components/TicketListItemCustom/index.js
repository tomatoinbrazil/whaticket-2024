      ...
      >
            ...
            <span className={classes.contactNameWrapper}>
              ...
              > {ticket.lastMessage.includes('data:image/png;base64') ? <MarkdownWrapper> Localização</MarkdownWrapper> : <MarkdownWrapper>{ticket.lastMessage}</MarkdownWrapper>}
                <span className={classes.secondaryContentSecond} >
                  {ticket?.whatsapp?.name ? <Badge className={classes.connectionTag}>{ticket?.whatsapp?.name?.toLowerCase()}</Badge> : <br></br>}
                  {ticketUser ? <Badge
                    style={{
                      border: '1px solid #69bcf0',
                      backgroundColor: 'transparent',
                      color: '#69bcf0',
                      borderRadius: 12,
                      margin: 3,
                    ...
                    className={classes.connectionTag}>{ticketUser.toLowerCase()}</Badge> : <br></br>}
                  <Badge style={{
                    border: `1px solid ${ticket.queue?.color || "#aeb4b8"}`,
                    backgroundColor: 'transparent',
                    borderRadius: 12,
                    color: '#aeb4b8',
                    margin: 3,
                    ...
                    paddingLeft: 8,
                    paddingRight: 8,
                  }} className={classes.connectionTag}>{ticket.queue?.name || "sem fila"}</Badge>
                </span>
        ...
        <ListItemSecondaryAction>
          ...
          <span className={classes.secondaryContentSecond} >
            ...
            {(ticket.status === "closed") && (
              <ButtonWithSpinner
                //color="primary"
                style={{ backgroundColor: 'red', color: 'white', padding: '0px', bottom: '0px', borderRadius: '0px', left: '8px', fontSize: '8px', marginLeft: isSameDay(parseISO(ticket.updatedAt), new Date()) ? -33 : -7 }}
                variant="contained"
                className={classes.acceptButton}
                size="small"
                loading={loading}
        ...
        {/* <span className={classes.secondaryContentSecond} >
          {ticket.status === "pending" && (
            <ButtonWithSpinner
              //color="primary"
              style={{ backgroundColor: 'green', color: 'white', padding: '2px 2px 2px 2px', bottom: '17px', borderRadius: '7px', left: '8px', fontSize: '8px' }}
              variant="contained"
              className={classes.acceptButton}
              size="small"
              loading={loading}
          ...
          {(ticket.status !== "closed") && (
            <ButtonWithSpinner
              //color="primary"
              style={{ backgroundColor: 'red', color: 'white', padding: '2px 2px 2px 2px', bottom: '0px', borderRadius: '7px', left: '8px', fontSize: '8px' }}
              variant="contained"
              className={classes.acceptButton}
              size="small"
              loading={loading}
          ...
          {(ticket.status === "closed") && (
            <ButtonWithSpinner
              //color="primary"
              style={{ backgroundColor: 'red', color: 'white', padding: '0px', bottom: '0px', borderRadius: '0px', left: '8px', fontSize: '8px' }}
              variant="contained"
              className={classes.acceptButton}
              size="small"
              loading={loading}
