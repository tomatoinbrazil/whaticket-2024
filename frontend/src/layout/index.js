    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          <IconButton edge="start" onClick={() => setViewLanguage(!viewLanguage)}>
            {theme.mode === 'dark' ? <LanguageIcon style={{ color: "white" }} /> : <LanguageIcon style={{ color: "white" }} />}
          </IconButton>
      ...
      {
      viewLanguage && (
        <Language onClose={setViewLanguage}/>
      )
    } 
