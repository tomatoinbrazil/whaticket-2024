                        ...
                        <Form>
                            <DialogContent dividers>
                                ...
                                <div className={classes.root}>
                                    ...
                                    <Chip variant="outlined" color="secondary" label="*%chavePix%*" onClick={() => navigator.clipboard.writeText('*%chavePix%*')} />
                                    <Chip variant="outlined" color="secondary" label="*%codBoleto%*" onClick={() => navigator.clipboard.writeText('*%codBoleto%*')} />
                                </div>
                                <div>
                                    <Typography style={{ marginBottom: 8, marginTop: 12 }} variant="subtitle1">
                                    </Typography></div>
                                ...
                                <div>
                                    <Field
                                        as={TextField}
                                        required
                                        label="Mensagem 3 dias após vencimento"
                                        type="msg3AposVenc"
                                        multiline
                                        rows={4}
                                        fullWidth
                                        name="msg3AposVenc"
                                        error={
                                            touched.msg3AposVenc &&
                                            Boolean(errors.msg3AposVenc)
                                        }
                                        helperText={
                                            touched.msg3AposVenc && errors.msg3AposVenc
                                        }
                                        variant="outlined"
                                        margin="dense"
                                    />
