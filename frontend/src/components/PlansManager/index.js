                        ...
                        <Grid xs={12} sm={8} md={2} item>
                            <FormControl margin="dense" variant="outlined" fullWidth>
                                ...
                                <Field
                                    ...
                                    label="Automações"
                                    labelId="useAutomation-selection-label"
                                    name="useAutomation"
                                    margin="dense"
                                >
                                    <MenuItem value={true}>{i18n.t("plans.form.enabled")}</MenuItem>
                        ...
                        <Grid xs={12} sm={8} md={2} item>
                            <FormControl margin="dense" variant="outlined" fullWidth>
                                ...
                                <Field
                                    ...
                                    label="Automações"
                                    labelId="useFlow-selection-label"
                                    name="useFlow"
                                    margin="dense"
                                >
                                    <MenuItem value={true}>{i18n.t("plans.form.enabled")}</MenuItem>
                        ...
                        <Grid xs={12} sm={8} md={2} item>
                            <FormControl margin="dense" variant="outlined" fullWidth>
                                ...
                                <Field
                                    ...
                                    label="Automações"
                                    labelId="usePowerCrm-selection-label"
                                    name="usePowerCrm"
                                    margin="dense"
                                >
                                    <MenuItem value={true}>{i18n.t("plans.form.enabled")}</MenuItem>
            ...
            >
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="center">Automações</TableCell>
                        <TableCell align="center">Flow Builder</TableCell>
                        <TableCell align="center">Power Crm</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {records.map((row) => (
                        <TableRow key={row.id}>
                            ...
                            <TableCell align="center">{renderAutomations(row)}</TableCell>
                            <TableCell align="center">{renderFlow(row)}</TableCell>
                            <TableCell align="center">{renderPowerCrm(row)}</TableCell>
                        </TableRow>
                    ))}
                </TableBody>
            </Table>
