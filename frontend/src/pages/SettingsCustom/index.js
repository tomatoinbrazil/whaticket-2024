...
import PowerCRM from "../../components/Settings/PowerCrm.js";
    ...
    <MainContainer className={classes.root}>
      ...
      <Paper className={classes.mainPaper} elevation={1}>
        ...
        >
          ...
          {process.env.REACT_APP_ENABLE_POWER_CRM === "true" && powerCRMEnabled === true ? <Tab label="Power CRM" value={"Power CRM"} /> : null}
        ...
        <Paper className={classes.paper} elevation={0}>
          ...
          <TabPanel className={classes.container} value={tab} name={"Power CRM"}>
            <PowerCRM
              settings={settings}
              scheduleTypeChanged={(value) =>
                setSchedulesEnabled(value === "company")
