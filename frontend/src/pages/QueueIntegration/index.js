...
import smartgps from "../../assets/smartgps-icon.png";
// import smartgpsNotify from "../../assets/smart-notify.png";
              ...
              {queueIntegration.map((integration) => (
                <TableRow key={integration.id}>
                  <TableCell >
                    ...
                    {integration.type === "smartgps" && (<Avatar
                      src={smartgps} className={classes.avatar} />)}
                    {integration.type === "flowbuilder" && (<FlowIco style={{fontSize: '53px'}} color="#000"/>)}
                    {/* {integration.type === "smartgpsAutoChat" && (<Avatar
                      src={smartgpsNotify} className={classes.avatar} />)} */}
                  </TableCell>
