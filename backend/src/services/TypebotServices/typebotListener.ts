                ...
                for (const message of messages) {
                  if (message.type === 'video' ) {
                    ...
                    await wbot.presenceSubscribe(msg.key.remoteJid)
                        ...
                        await wbot.sendMessage(msg.key.remoteJid, { text: `https://${message.content.url}` });

                    // const media = {
                    //     video: {
                    //         // url: `https://www.${message.content.url}`,
                    //         // url:'https://www.youtube.com/embed/S-apbPUY6YA',
                    //         url: 'https://firebasestorage.googleapis.com/v0/b/weconnect-d7b32.appspot.com/o/Screen%20Recording%202024-02-01%20at%2015.52.55.mov?alt=media&token=321bfdf4-571f-4463-9c4b-208b3b882089'
                    //     },
